...
export default function CatadorEditProfileScreen({ navigation }) {
  ...
  async function editSubmit(userEdited) {
    ...
    try {
      ...
      newInfos.tipo = "catador";
      updateUser(newInfos);
      navigation.navigate("Profile Catador");
      showMessage({
  ...
  const editProfileValidationSchema = yup.object().shape({
    ...
    number: yup.string().matches(/\d/, "Entre com um número válido"),
