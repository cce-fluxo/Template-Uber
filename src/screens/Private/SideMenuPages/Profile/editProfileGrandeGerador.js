...
export default function EditProfileGrandeGerador({ navigation }) {
  ...
  async function editSubmit(userEdited) {
    ...
    if (numberOfPeople) {
      objForBack.numero_pessoas = parseInt(numberOfPeople);
    } else {
      objForBack.numero_pessoas = numberOfPeopleOptions.filter(
        (option) => option.id === user?.grande_gerador?.numero_pessoas
      )[0]?.id;
    }
  ...
  const editProfileValidationSchema = yup.object().shape({
    ...
    numero_pessoas: yup
      .string()
      .matches(/\w/, "Entre com o número de funcionários")
      ...
      >
        <Formik
          ...
          initialValues={{
            ...
            city: user.city,
            state: user.state,
            cpf: user.grande_gerador?.cpf,
            cnpj: user.grande_gerador?.cnpj,
            razao_social: user.grande_gerador?.razao_social,
            numero_pessoas: numberOfPeopleOptions.filter(
              (option) => option.id === user?.grande_gerador?.numero_pessoas
            )[0]?.name,
            ...
            <>
              ...
              >
                <View style={styles.background}>
                  ...
                  />
                  {errors.razao_social && touched.razao_social && (
                    <Text style={styles.errorText}>{errors.razao_social}</Text>
                  )}
                  ...
                  <TextInput
                    style={
                      errors.numero_pessoas && touched.numero_pessoas
                        ? styles.errorInput
                        : styles.input
                    }
                    name="numero_pessoas"
                  ...
                  <SelectInputModal
                    ...
                    data={numberOfPeopleOptions}
                    title="Selecione o número de trabalhadores"
                    setData={setNumberOfPeople}
                  />
                </View>
              </ScrollView>
            </>
