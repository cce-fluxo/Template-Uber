...
import SelectCompaniesModal from "../../../components/modals/selectCompanieModal";

const SingUpGrandeGerador = ({ navigation, route }) => {
  ...
  const companiesModalRef = useRef(null);
  ...
  async function signUp(user) {
    ...
    data.city = city;
    data.numero_pessoas = parseInt(numberOfPeople);
    data.status = "active";
        ...
        {({
          ...
          <>
            ...
            >
              <View style={styles.background}>
                <>
                  ...
                  {/* <TextInput
                        style={
                          errors.empresa_id && touched.empresa_id
                            ? styles.errorInput
                            : styles.input
                        }
                        name="empresa_id"
                        ...
                        showSoftInputOnFocus={false}
                        onBlur={handleBlur("empresa_id")}
                        value={values?.empresa_id}
                        onFocus={() => {
                          Keyboard.dismiss();
                          openOptionsModal(companiesModalRef);
                        }}
                      />
                      {errors.empresa_id && touched.empresa_id && (
                        <Text style={styles.errorText}>
            ...
            {/* <SelectCompaniesModal
              modalRef={companiesModalRef}
              handleChange={handleChange}
              title="Selecione a empresa parceira"
              setData={setCompanieId}
            /> */}
          </>
        )}
      </Formik>
...
export default SingUpGrandeGerador;
